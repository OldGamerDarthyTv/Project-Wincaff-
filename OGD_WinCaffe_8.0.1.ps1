...
function Show-OgdAppliedSummary {
    ...
    switch($Profile){
        ...
        'FIXPRE778' {
Show-OgdWhatThisDoes 'Fix pre-7.8.1: cosa è stato fatto davvero' @(
                'ripristinati in modo sicuro alcuni settaggi troppo aggressivi o teorici delle build precedenti',
                'riattivate o riportate in stato prudente funzioni utili per stabilità, diagnosi e manutenzione',
                'menu pensato per bonificare il sistema prima di applicare i preset più recenti e più puliti'
            )
        }
    }
}
...
Write-Host "  [H] 🩹 HOTFIX 8.0.0 - DX9 legacy + OpenDyslexic + NPU diag" -F Cyan
Write-Host "  [J] 🧰 FIX PRE 8.0.0 - Bonifica tweak vecchie versioni" -F Yellow
